          ...
          <h4 class="mb-3 text-primary">Data Diri</h4>
            <div class="row g-3">
              <div class="col-sm-12">
                ...
                <input type="text" name="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Contoh : Bambang " required  oninvalid="this.setCustomValidity('Nama Harus di Isi')" oninput="this.setCustomValidity('')">
                @error('name')
