                    ...
                    <form action="{{ $url }}" method="post">
                            ...
                            <div class="col-12 col-sm-6 form-group">
                                ...
                                <select name="subscribe_package_id" id="subscribe_package_id" class="form-control form-control-sm" required>
                                    ...
                                    @foreach ($packages as $package)
                                        <option value="{{ $package->id }}" @selected($package->id == ($record->subscribe_package_id ?? ''))>{{ $package->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 form-group">
                                ...
                                <input type="date" name="start_date" id="start_date" class="form-control form-control-sm" value="{{ $record->start_date ?? 0.00 }}" required>
                            </div>
                            <div class="col-12 col-sm-6 form-group">
                                <label for="end_date" class="form-label">End Date</label>
                                <input type="date" name="end_date" id="end_date" class="form-control form-control-sm" value="{{ $record->end_date ?? 0.00 }}" required>
                            </div>
                        </div>
