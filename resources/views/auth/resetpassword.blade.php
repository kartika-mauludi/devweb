...
<div class="col-md-12">   
 <div class="row">
        ...
        <div class="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
			...
			<h3>Hai {{ $user->name  }}</h3>
			<h4>Kamu menerima email ini karena, kamu meminta reset password untuk akun kamu, klik tombol dibawah untuk reset password kamu</h4>
			<center>
			<a href="{{ url($url) }}" class="btn m3">Reset Password</a> 
		</center>
